...
def cli():
    ...
    parser.add_argument('--source-dir',    dest='location',     metavar="DIRECTORY",  help='Set the source directory of the Paragnosis toolset (current: {})'.format(settings.get("location", "unknown")), type=str, default=settings.get("location"))
